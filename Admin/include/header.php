        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php"><img src="images/logo4.jpg" class="logo" alt="Cattle Vaccination"></a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="navbar-menu" style="margin-top: 40px;">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <li class="nav-item"><a class="nav-link" href="adminaddvcenter.php">Add Vaccine Center</a></li>
                        <li class="nav-item"><a class="nav-link" href="adminviewvcenter.php">View Vaccine Center</a></li>
                    </ul>
                </div>
                <!-- /.navbar-collapse -->
            </div>
