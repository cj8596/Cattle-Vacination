            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu" style="margin-top: 40px;">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <li class="nav-item"><a class="nav-link" href="viewrequest.php">View Request</a></li>
                        <li class="nav-item"><a class="nav-link" href="viewvaccineinfo.php">Vaccine Details</a></li>
                        <li class="nav-item"><a class="nav-link" href="vcenteraddvaccine.php">Add Vaccine</a></li>
                        <li class="nav-item"><a class="nav-link" href="vaccineUpdates.php">Vaccine Updates</a></li>
                    </ul>
                </div>
                <!-- /.navbar-collapse -->
            </div>
